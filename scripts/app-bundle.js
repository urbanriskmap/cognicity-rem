define('api',['exports', 'aurelia-framework', 'aurelia-fetch-client', 'topojson-client', './environment'], function (exports, _aureliaFramework, _aureliaFetchClient, _topojsonClient, _environment) {
  'use strict';
  ...
  var DATA_URL = _environment2.default.dataUrl;

  var auth = { headers: { 'Authorization': 'Bearer ' + localStorage.getItem('id_token') } };

  var convertTopoToGeo = function convertTopoToGeo(data) {
    return new Promise(function (resolve, reject) {
      if (!data || !data.result || data.result.type != 'Topology') reject(new Error('Unexpected response from data server'));
      var geojson = topojson.feature(data.result, data.result.objects.output);
      resolve(geojson);
    });
  };
...
define('home',['exports', 'aurelia-framework', './app'], function (exports, _aureliaFramework, _app) {
  'use strict';
  ...
  var Home = exports.Home = (_dec = (0, _aureliaFramework.inject)(_app.App), _dec(_class = function Home(app) {
  ...
  var Map = exports.Map = (_dec = (0, _aureliaFramework.inject)(_api.API, _aureliaI18n.I18N), _dec2 = (0, _aureliaFramework.bindable)({ defaultBindingMode: _aureliaFramework.bindingMode.twoWay }), _dec(_class = (_class2 = function () {
    ...
    Map.prototype.attached = function attached() {
      ...
      for (var _iterator = config.basemaps, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
        ...
        var layer = L.tileLayer(basemap.url, basemap.options).addTo(this.map);
          ...
          onEachFeature: function onEachFeature(feature, layer) {
            ...
            layer.on({
              ...
              click: function click(e) {
                ...
                _this.map.fitBounds(e.target.getBounds(), { maxZoom: 15 });
      ...
      var _loop = function _loop() {
        ...
        var infrastructure = _ref2;

        infrastructureLayers[infrastructure.name] = null;

        layerPromises.push(_this.api.getInfrastructure(infrastructure.type).then(function (data) {
      ...
      for (var _iterator2 = config.infrastructure, _isArray2 = Array.isArray(_iterator2), _i2 = 0, _iterator2 = _isArray2 ? _iterator2 : _iterator2[Symbol.iterator]();;) {
        var _ref2;
